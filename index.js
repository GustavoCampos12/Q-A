...
function exibirResultadoUsuario ( pontuacaoFinal, NomeUsuario ){
...
function IniciarQuiz (){
  ...
  const NomeUsuario = entradaDados.question('Digite seu nome: ');
  ...
  exibirResultadoUsuario(pontuacaoFinal, NomeUsuario);
}
